...
build do
  ...
  if linux_target? and !heroku_target?
    ...
    command_on_repo_root "bazelisk run #{bazel_flags} //pkg/procmgr/rust:install_windows -- --destdir=#{install_dir}", :env => env, :live_stream => Omnibus.logger.live_stream(:info)
  end
